...
class donaldsLogged extends StatefulWidget {
  @override
  _donaldsLoggedState createState() => _donaldsLoggedState();
}

class _donaldsLoggedState extends State<donaldsLogged> {
  bool loading =false;
  QuerySnapshot dish;
  ...
  @override
  void initState() {
    databaseService.getData('donalds').then(
            (results){
          setState(() {
            dish = results;
          });
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("McDonalds Breakfast menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 23.0,
                                    ),
                                    ),
                                  ]
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("Mcdonalds Lunch menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 23.0,
                                    ),
                                    ),
                                  ]
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("Mcdonalds Dinner menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 23.0,
                                    ),
                                    ),
                                  ]
