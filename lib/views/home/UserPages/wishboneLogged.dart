...
class wishboneLogged extends StatefulWidget {
  @override
  _wishboneLoggedState createState() => _wishboneLoggedState();
}

class _wishboneLoggedState extends State<wishboneLogged> {
  bool loading =false;
  QuerySnapshot dish;
  ...
  @override
  void initState() {
    databaseService.getData('Pizza King & Wishbone').then(
            (results){
          setState(() {
            dish = results;
          });
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("Pizza King & Wishbone Breakfast menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 23.0,
                                    ),
                                    ),
                                  ]
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("Pizza King & Wishbone Lunch menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 23.0,
                                    ),
                                    ),
                                  ]
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("Pizza King & Wishbone Dinner menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 23.0,
                                    ),
                                    ),
                                  ]
