...
class wishbonePage extends StatefulWidget {
  @override
  _wishbonePageState createState() =>_wishbonePageState();
}

class _wishbonePageState extends State<wishbonePage> {
  bool loading =false;
  QuerySnapshot dish;
  String img;
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("wishbone Breakfast menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 28.0,
                                    ),
                                    ),
                                  ]
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("wishbone Lunch menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 32.0,
                                    ),
                                    ),
                                  ]
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("wishbone Dinner menu", style: TextStyle(//fontWeight:FontWeight.bold,
                                      fontSize: 32.0,
                                    ),
                                    ),
                                  ]
